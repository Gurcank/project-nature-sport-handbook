export const translations = {
  en: {
    ...
    mountainSports: 'Mountain Sports',
    trailSports: 'Trail Sports',
    ...
    // Plants Page
    plantsEncyclopedia: 'Plants Encyclopedia',
    discoverPlants: 'Discover fascinating plants from around the world',
    searchPlants: 'Search plants by name or scientific name...',
    filters: 'Filters',
    climate: 'Climate',
    region: 'Region',
    type: 'Type',
    ...
    // Animals Page
    animalsEncyclopedia: 'Animals Encyclopedia',
    searchAnimals: 'Search animals...',

    // Stones Page
    stonesEncyclopedia: 'Stones & Minerals Encyclopedia',
    searchStones: 'Search stones...',

    // Hiking Page
    hikingGuidesAndTips: 'Hiking Guides & Tips',
  ...
  tr: {
    ...
    mountainSports: 'Dağ Sporları',
    trailSports: 'Yürüyüş Sporları',
    airSports: 'Hava Sporları',
    plants: 'Bitkiler',
    animals: 'Hayvanlar',
    stones: 'Taşlar ve Mineraller',
    hiking: 'Yürüyüş',
    trekking: 'Trekking',
    canoe: 'Kano',
    settings: 'Ayarlar',
    ...
    discoverPlants: 'Dünyanın dört bir yanından ilginç bitkileri keşfedin',
    searchPlants: 'Bitkileri ad veya bilimsel adla arayın...',
    filters: 'Filtreler',
    climate: 'İklim',
    region: 'Bölge',
    type: 'Tür',
    ...
    allClimates: 'Tüm İklimler',
    allRegions: 'Tüm Bölgeler',
    allTypes: 'Tüm Türler',
    nameAZ: 'Ad (A-Z)',
    showing: 'Gösteriliyor',
    of: 'tanesi',
    noPlantsFound: 'Bitki bulunamadı',
    tryAdjusting: 'Arama veya filtre kriterlerinizi ayarlamayı deneyin',
    clearFilters: 'Filtreleri Temizle',

    // Animals Page
    animalsEncyclopedia: 'Hayvanlar Ansiklopedisi',
    searchAnimals: 'Hayvanları ara...',

    // Stones Page
    stonesEncyclopedia: 'Taşlar ve Mineraller Ansiklopedisi',
    searchStones: 'Taşları ara...',

    // Hiking Page
    hikingGuidesAndTips: 'Yürüyüş Rehberleri ve İpuçları',
...
export function t(key: keyof typeof translations.en, language: 'en' | 'tr'): string {
